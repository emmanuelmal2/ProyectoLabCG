...
public:
	...
	// Devuelve el ID de la primera textura difusa encontrada
	GLuint getFirstDiffuseTextureID() const {
		...
		return 0; // Retorna 0 si no hay textura difusa (esto podría causar fallback o error en OpenGL)
	}
